...
class Map {
    ...
    drawMap(world) {
        ...
        // We have provided a class structure for the data called CountryData that you should assign the parameters to in your mapping
       ...
       // console.log(countryData);
        ...
        //console.log(path);
        svg.selectAll('path').data(countryData).enter().append('path').attr('d', path).attr('class', function (d){ return d.region ? d.region : ""}).classed('boundary', true).classed('countries', true).attr('id', d =>  d.id);

        svg.append("path").datum({type: "Sphere"}).attr("id", "sphere").attr("d", path).attr("class", "stroke");
